...
from utils.eval_utils import load_file, process_input_data, postprocess_output, test_kilt_em, match
...
def main():
    ...
    parser.add_argument('--model_name_or_path', type=str,
                        default='/home/lixz23/pretrain-model/minicpm-2b-sft-bf16')
    parser.add_argument('--input_file', type=str, default='/home/lixz23/ragsft/data/wikimulti_data/dev_list.jsonl')
    ...
    parser.add_argument('--user_chat_template', action='store_true',default=True)
