...
class LLMReranker:
    ...
    def sort(self, chunks: List[str], query: str):
        ...
        with torch.no_grad():
            ...
            return scores.argsort()[::-1][0:self.topn], sorted_scores
...
def main():
    ...
    parser.add_argument('--dataset_file_path', type=str,
                        default="/home/lixz23/ragsft/data/marco_v2.1/minicpm_retriever_128_256_top100_test/rag_2024_psg.jsonl")
    parser.add_argument('--model_name_or_path', type=str,
                        default="/data/groups/QY_LLM_Other/meisen/pretrained_model/newbgererank")
    parser.add_argument('--output_path', type=str,
                        default="/home/meis23/project/trec_match/trec_data/rerank")
    parser.add_argument('--file_name', type=str,
                        default="rag_2024_psg_rerank_score.jsonl")
    ...
    for example in tqdm(data, desc="Processing examples"):
        ...
        indexes, sorted_scores = reranker.sort(chunks=passages, query=question)
        example['rerank_indexs'] = indexes.tolist()
        example['sorted_scores'] = sorted_scores.tolist()
