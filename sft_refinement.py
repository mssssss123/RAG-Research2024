from src.dataset import preprocess_function_radit_llama_v2, preprocess_function_radit_minicpm_v2, preprocess_function_radit_minicpm_v3, preprocess_function_radit_llama_v3,preprocess_function_refinement_llama
...
def main():
    ...
    if args.model_name == 'llama':
        encode_function = partial(
            preprocess_function_refinement_llama,
            tokenizer=tokenizer,
        ...
        encode_function = partial(
            preprocess_function_radit_minicpm_v3,
            tokenizer=tokenizer,
            max_seq_length=args.max_seq_length,
            max_psg_length=args.max_psg_length,
            num_passage=args.num_passage,
