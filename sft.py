from src.dataset import preprocess_function_radit_llama_v2, preprocess_function_radit_minicpm_v2, preprocess_function_radit_minicpm_v3, preprocess_function_radit_llama_v3, preprocess_function_radit_llama_dpo, preprocess_function_radit_minicpm_dpo
from utils.train_args import debug_parse_args, parse_args
import logging
import math
import os
import random
...
def main():
    ...
    if args.model_name == 'llama':
        encode_function = partial(
            preprocess_function_radit_llama_dpo,
            tokenizer=tokenizer,
            max_seq_length=args.max_seq_length,
            max_psg_length=args.max_psg_length,
            is_instruct=args.is_instruct,
            num_passage=args.num_passage,
        )
    else:
        encode_function = partial(
            preprocess_function_radit_minicpm_dpo,
            tokenizer=tokenizer,
            max_seq_length=args.max_seq_length,
            max_psg_length=args.max_psg_length,
            num_passage=args.num_passage,
